"""Plain (non-fixture) test helpers, importable as `from support import ...`.

pytest's default import mode prepends each test file's directory to sys.path,
so sibling test modules can import this directly.
"""
